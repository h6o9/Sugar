                    ...
                    @foreach ($orders->groupBy('order.code') as $orderGroup)
                        ...
                        <div class="mt-2">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="total-value m-0">£{{ number_format($order->order->total_amount - $order->tip - $order->branch->tax - ($order->order->delivery_charge ?? 0) - $order->order->gateway_fee, 2) }}
                                </p>
                            </div>
                            <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-between">
                                <p class="text-muted mb-1">Stripe Fee</p>
                                <p class="delivery-charge mb-1">£{{ number_format($order->order->gateway_fee ?? 0, 2) }}</p>
                            </div>
                            <div class="d-flex justify-content-between">
                                    <p class="text-muted m-0">Estimated order total</p>
                                    <p class="total-value m-0">£{{ number_format($order->order->total_amount ?? 0, 2) }}
                                    </p>
                            </div>
                        </div>
                        <!-- Billing End -->
                                                ...
                                                <div class="mt-2">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <p class="total-value m-0">
                                                            £{{ number_format($order->order->total_amount - $order->tip - $order->branch->tax - ($order->order->delivery_charge ?? 0) - $order->order->gateway_fee, 2) }}
                                                        </p>
                                                    </div>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="text-muted mb-1">Estimated taxes (New York)</p>
